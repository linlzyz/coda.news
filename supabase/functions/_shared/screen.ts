...
export const CRIME = /\b((?<!cardiac )arrest(ed|s)?|fugitive|murder(ed|er)?|homicide|stabb(ed|ing)|(mass|fatal) shooting|shooting (attack|suspect|victim)|gunman|kidnap(ped|ping)?|smuggl(ing|er|ed)|traffick(ing|er)|drug (bust|lord|ring)|jailed|imprisoned|sentenced|convicted|extradit(ed|ion)|cocaine|heroin|methamphetamine|drug[- ]driv(ing|er)|drink[- ]driv(ing|er)|dui|charged with|pleaded (not )?guilty|police (allege|say|said|charged)|assault(ed)?)\b|可卡因|毒驾|酒驾|涉毒|吸毒|醉驾|逮捕|逃犯|通缉|警方|嫌犯|嫌疑人|被捕|拘留|刑拘|判刑|诈骗团伙|走私|贩毒|杀人|命案/i;
...
K = keep: a specific, new event in technology, business/economy/markets, sport (results, transfers, squads, coaches), entertainment (releases, box office, awards, celebrities), fashion (shows, collections, brands, designers), travel (new hotels and resorts, destination guides and "best of" lists from travel magazines, new routes, visas; never crime or accidents in tourist places), cars (carmakers, EVs, launches) or video games (games, studios, consoles, esports).
D = drop: politics, government, diplomacy, war, military, crime, courts, accidents, disasters, weather, health advice, education, memorials, religion, lifestyle or beauty tips, how-to guides, reviews, shopping deals, listicles (except travel guides and hotel lists), horoscopes, recipes, opinion or analysis columns, local or city-level news (a city, district or county project, local government notices, community or neighbourhood works, regional livelihood programmes), previews, explainers, live blogs, roundups.
