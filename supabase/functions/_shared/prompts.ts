...
- In every English field, names are in English: pinyin or the usual romanisation for people named in the articles, and the usual English names for companies and outlets. Never leave Chinese, Japanese or Korean characters in English text. Only use names that appear in the articles.
...
- travel: magazine-style travel: new hotels and resorts opening, destination guides and "best places" lists from travel magazines, new restaurants and attractions, new routes and trains, visa and border rules for travellers, cruises, travel trends. NOT crime, accidents, disasters or police stories set in tourist places.
false for: market roundups (a travel magazine's destination guide or "best hotels" list IS relevant as travel), live blogs and "what happened today" digests that cover several unrelated stories, opinion columns, how-to guides, reviews of products already on sale (a new product reveal or launch with its specs, price or first look IS relevant: "Here's the new X", "X revealed", "I saw X in person"), shopping deals, horoscopes, quizzes, podcasts, recipes, politics, military, crime and criminal allegations, accidents, weather, anonymous blind items, paparazzi speculation about bodies, health or sexuality, and local or regional stories: a city, district, county or province promoting itself, local tourism or culture campaigns, folk festivals, local government projects and notices, regional agriculture or livelihood programmes. Keep only news a reader in another country would care about.
