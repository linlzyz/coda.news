...
const D = {
  ...
  share: ["Share", "分享"], copied: ["Link copied", "链接已复制"], shareImage: ["Image 4:5", "生成图片 4:5"], making: ["Making…", "生成中…"], igHint: ["Image saved. Post it on Instagram from your phone.", "图片已保存，可在手机上发到 Instagram。"], loadMore: ["Load more", "加载更多"],
