...
const D = {
  ...
  nlTitle: ["coda.news Daily Brief", "coda.news 每日简报"], nlText: ["The day's biggest tech and economy events, and how each side of the world told them.", "每天最重要的科技与经济事件，以及世界各地如何报道。"],
