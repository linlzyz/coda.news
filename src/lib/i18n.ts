...
const D = {
  ...
  countries: ["countries", "个国家"], country: ["country", "个国家"], trending: ["Trending", "热门"], latest: ["Latest news", "最新"], updateNote: ["updated every 5 min", "每 5 分钟更新"], keyStories: ["Picks", "精选"], newProducts: ["New launches", "新品速览"], newProductsSub: ["Cars, devices, games and collections unveiled in the last three days", "最近三天发布的新车、新机、新游戏和新款"],
