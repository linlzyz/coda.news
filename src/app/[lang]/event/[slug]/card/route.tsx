...
export async function GET(_: Request, { params }: { params: Promise<{ lang: string; slug: string }> }) {
  ...
  const labels = zh
    ? { how: "各国怎么说", meta: `${e.countries.length} 个国家 · ${e.source_count} 个来源`, cta: "在 coda.news 对比各国报道", cat: { technology: "科技", economy: "经济", sport: "体育", entertainment: "娱乐", fashion: "时尚", travel: "旅行", automotive: "汽车", gaming: "游戏" }[e.category] ?? "" }
