  ...
  return (
    <header className="sticky top-0 z-20 border-b border-[#E5E7EB] bg-white/90 backdrop-blur">
      ...
      <nav className="flex gap-1 overflow-x-auto px-3 pb-2 lg:hidden">
        {([["home", "/"], ["anatomy", "/anatomy"], ["economy", "/economy"], ["technology", "/technology"], ["sport", "/sport"], ["entertainment", "/entertainment"], ["fashion", "/fashion"], ["automotive", "/automotive"], ["gaming", "/gaming"], ["australia", "/australia"], ["china", "/china"], ["companies", "/companies"], ["topics", "/topics"]] as const).map(([k, h]) => (
