...
export function Flag({ code, size = 16 }: { code: string; size?: number }) {
  ...
  const style = { width: size * 1.5, height: size, borderRadius: 3, boxShadow: "0 0 0 1px rgba(10,26,51,.12)" };
  if (!F) return <span className="inline-block bg-[#D6E2F5]" style={style} aria-label={countryName(code)} />;
